 ...
 * slightly modified version to make it work with JWKS, see line 115
...
library Base64Url {
    ...
    bytes internal constant DECODING_TABLE =
        hex"";
    ...
    {
        // removed the string conversion as it was messing with the encoding.
        // now we just use the bytes version of the value
        ...
        // CAUTION: I had to add +1 to the decoded length to make it work for the JWKSOracle 
        // https://github.com/hir0min/solidity-base64/issues/1
